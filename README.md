...
> **[vet_clinic]** is a Database that holds animal data. This project offers the ability to store, retrieve, and analyze relevant data, which is instrumental to the smooth operation of the vet_clinic.  
...
```sh
  cd my-folder
  git clone https://github.com/Enoisong/vets_clinic.git
```
